...
export default function App() {
  ...
  const handleFormSubmit = (e) => {
    ...
    const waUrl = `https://wa.me/${pageData.phone}?text=Hello%20Aetheria%20Games,%20saya%20${encodeURIComponent(name)}%20(${encodeURIComponent(email)}).%20Saya%20tertarik%20dengan%20${encodeURIComponent(interest)}.%20Pesan:%20${encodeURIComponent(message)}`;
